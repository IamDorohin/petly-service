      ...
      <SC.FooterSection>
        ...
        <Modal active={modalActive} setActive={setModalActive}>
          <SC.TeamWrapper>
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/gradussus"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/LenaK513"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/IvanBlazhko"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/Natali2721"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/Slapchenko"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/AlexCheverda"
                target="_blank"
                rel="noreferrer"
              >
                <SC.TeamImage
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/andrii-pozniak"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/Albertukraine"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/darinacat87"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/maksnovakov"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <SC.TeamCard>
              <SC.TeamLink
                href="https://github.com/MykolaPom"
                target="_blank"
                rel="noreferrer"
              >
