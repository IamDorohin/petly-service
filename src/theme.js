...
const darkTheme = createTheme({
  ...
  customColors: {
    appBackground: 'rgba(0, 0, 0, 0.87)',
    cardsBackground: '#000000',
    accent: '#F57C00',
    primaryFont: '#F2D2BD',
    homeHeroTitleFont: '#F2D2BD',
    navigationFont: '#F2D2BD',
    accentFont: '#111111',
    errorNotif: '#E2001A',
    successNotif: '#3CBC81',
    loginLink: '#3091EB',
    deleteButton: '#FF6101',
    translucentBlack: 'rgba(238, 238, 238, 0.6)',
    photoDescription: 'rgba(255, 255, 255, 0.6)',
    searchBarPlaceholder: '#535353',
    newsDescription: '#E0E0E0',
  },

  customShadow: {
    primary: '7px 4px 14px rgba(255, 255, 255, 0.11)',
    secondary: '7px 4px 14px rgba(206, 234, 251, 0.07)',
    addButton: '0px 4px 14px rgba(255, 255, 255, 0.11)',
    popUp: '4px 4px 8px rgba(255, 255, 255, 0.25)',
  },
  ...
  customBorders: {
    primaryButtons: '2px solid #F57C00',
    secondaryButtons: '1px solid rgba(245, 146, 86, 0.5)',
    errorNotif: '1px solid #E2001A',
    successNotif: '1px solid #3CBC81',
  },
